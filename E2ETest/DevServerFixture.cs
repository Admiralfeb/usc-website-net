...
using UnitedSystemsCooperative.Web.E2ETest.BlazorDevServer;

namespace UnitedSystemsCooperative.Web.E2ETest;

public class DevServerFixture : IDisposable
{
    private readonly Lazy<Uri> _rootUriInitializer;

    public DevServerFixture()
    {
        _rootUriInitializer = new(() => new Uri(StartAndGetRootUri()));
    }
